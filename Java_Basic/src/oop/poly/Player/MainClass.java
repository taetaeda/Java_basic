...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		Warrior w1 = new Warrior ("정욱오크1");
		Warrior w2 = new Warrior ("정욱오크2");
		Mage m1 = new Mage("훈모zl존1");
		Mage m2 = new Mage("훈모zl존2");
		Hunter h1 = new Hunter("삼경궁수1");
		Hunter h2 = new Hunter("삼경궁수2");
