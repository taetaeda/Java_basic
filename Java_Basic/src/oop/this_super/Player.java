...
public class Player extends Object { // object 굳이 작성하지 않아도 모든 클래스는 object 다 있어
	...
	String name;
	   ...
	   Player(String name){
		   ...
		   //atk = 3;
		   //hp = 50;
		   this.name = name; // this 지금 생성되고 있는 그 객체의 주소값을 띄게 된다?
	   }
	   
	   Player(String name, int hp){
		   this(name); // 다른 생성자의 호출은 생성자 내에서 최상단에 위치해야 합니다. hp밑으로 내리면 안됨
	   ...
	   void attack(Player target) {
		   ...
		   //맞는 사람의 hp를 10낮추고 나의 체력을 5 회복하고 싶다.
