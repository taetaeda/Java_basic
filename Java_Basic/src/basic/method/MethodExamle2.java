...
//		} 
	 ...
	 static int calcNumberTotal2(int ...nums) {
		 //...nums :1개아 아닌 여러개를 받을 수 있다. 크기가 변한다.
		 int total = 0;
		 for(int n : nums) {
			 total += n;
		 }
	...
	public static void main(String[] args) {
		...
		// x 96 y 34 대입하면 96<=36 (x) 값은 0이 나온다
		System.out.println(result);
		
		System.out.println("밥 먹을까???\t" + selectRandomFood());
