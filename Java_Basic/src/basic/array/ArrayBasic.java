...
//		arr = 65; (x)
		...
		arr[1] = 88;
		arr[2] = arr[0];
		arr[3] = (int) 3.14; // (x, 배열은 int 배열이니까, 변환시켜줘야돼)
//		arr[4] = "들어갈까요?"; (x)
		arr[4] = 100;
//		arr[5] = 70; (x) index 범위를 초과하니까
		...
		//7. 배열 내부의 요소갑을 문자열 형태로 한눈에 출력하기
		...
		//기존의 배열으 조작하는 것이 아니라 새롭게 생성하셔야 합니다.
		String[] names = {"홍길동", "김철수", "박영희"};
//		names = {"홍길동", "김철수", "박영희", "김뽀삐"}; (x) 처음 하는게 아니니까 불가능
