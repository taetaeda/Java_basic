...
public class ListQuiz02 {
	...
	public static void main(String[] args) {
        ...
        */
		...
		List<User> Ict = new ArrayList<>();
		
		User ict1 = new User("원정욱",26);
		User ict2 = new User("성삼경",30);
		User ict3 = new User("유훈모",25);
		
		Ict.add(ict1);
		Ict.add(ict2);
		Ict.add(ict3);
		
//		Collections.addAll(Ict,new User("원정욱",26),
//				new User("성삼경",30),new User("유훈모",25));
...
//			if(name.equals("원정욱")) {       ex1
//				Ict.remove(i);
//			}
			if(Ict.remove(i) == ict1) {
				Ict.remove(ict1);         // ex2
