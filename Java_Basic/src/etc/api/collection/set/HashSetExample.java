...
public class HashSetExample {
	...
	public static void main(String[] args) {
        ...
        */
		...
		//set을 List로 변환 하는 법 -> 생성자의 매개값으로 set을 전달.
		 ...
		 System.out.println(set);
		 /*
		  -객체에서 equals 매서드를 오버라이딩 할 때 hashCode도 같이
		  오버라이딩 해야하는 이유 
		  1. Hash 알고리즘을 사용하는 다른 객체가 본래의 속성을 띄게 하려면
		  객체의 필드값이 같았을 때 같은 hashCode의 값을 띄게 해줘야 한다.
...
//		Person won = new Person("원정욱",26);
//		Person sung = new Person("원정욱",26); 
		// hash코드가 같아서 하나만 뜬다.
		//[Person [이름=원정욱, 나이=26]]

		
		personSet.add(won);  personSet.add(sung);
